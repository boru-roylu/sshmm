...
from shmm_utils import init_model, plot_shmm, temperal_split, vertical_split
...
print(f'********** iteration 0 **********')
print(f'num_states = {num_states}; num_temperal_split = {num_temperal_split}; num_vertical_split = {num_vertical_split}')
...
for iteration in range(num_split):
    ...
    print(f'    Info: num_states = {num_states}; num_temperal_split = {num_temperal_split}; num_vertical_split = {num_vertical_split}')
